...
const EmptyIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_512_6906)">
        <path
          d="M32.5 39.7032C50.1731 39.7032 64.5 36.5925 64.5 32.7552C64.5 28.9179 50.1731 25.8071 32.5 25.8071C14.8269 25.8071 0.5 28.9179 0.5 32.7552C0.5 36.5925 14.8269 39.7032 32.5 39.7032Z"
          // fill="#CACACA"
          fill={props.color || theme.colors.gray7}
        />
        <path
