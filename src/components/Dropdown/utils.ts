import { DropdownHeightVariants, DropdownOptionType, DropdownWidthVariants, StrNumType } from './Dropdown';
...
export const getHeight = (heightSize: DropdownHeightVariants, height: StrNumType | undefined): string => {
